<div id="help-template" class="outer">
    <{include file=$smarty.const._MI_KOINS_HELP_HEADER}>

    <h4 class="odd">DESCRIPTION</h4> <br>

    <p class="even">The Koins module can create module icons as you select parts.
        Module developers without special image editing software can also easily create icons.
        By adding material images to become parts, it is also possible to increase variations of icons that can be created.<br> <br>
        Features:
    <ul>
        <li>Create a module icon</li>
        <li>You can download module icons</li>
        <li>Module icon can be reflected on external module</li>
    </ul>
    </p>
    <p class="odd"> How to add material parts</p>

    <p class="even"> Koins can freely add more visual assets.

        Storage location of visual parts

        plates /modules/koins/assets/images/plates
        icons /modules/koins/assets/images/icons
        font /modules/koins/assets/images/letters </p>

    <p class="odd">Logo plate:</p>

    <p class="even"> Add png image of 128x28. Please make it an image that makes it easy for marks to be synthesized on the left 28 x 28 area. </p>

    <p class="odd">Icons:</p>

    <p class="even"> Add a png image of 28x28. The color of the figure is basically white. Please make the background color transparent. </p>
