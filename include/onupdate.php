 ...
 */
function xoops_module_pre_update_koins(XoopsModule $module)
{
    $moduleDirName = basename(dirname(__DIR__));
    /** @var Koins\Helper $helper */
    /** @var Koins\Utility $utility */
...
function xoops_module_update_koins(XoopsModule $module, $previousVersion = null)
{
    $moduleDirName = basename(dirname(__DIR__));
    ...
    /** @var Koins\Helper $helper */
    /** @var Koins\Utility $utility */
    /** @var Koins\Configurator $configurator */
    $helper  = Koins\Helper::getInstance();
    $utility = new Koins\Utility();
    $configurator = new Koins\Configurator();

    if ($previousVersion < 240) {

        //rename column EXAMPLE
        $tables     = new Tables();
        $table      = 'koinsx_categories';
        $column     = 'ordre';
        $newName    = 'order';
